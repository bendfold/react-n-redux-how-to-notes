...
import errorHandlingContainer from './error-handling/errorHandlingContainer';
...
const App = () => ([
	...
	<Switch key={uuidv4()}>
		...
		<Route key={uuidv4()} path={ROUTE_PATH.errorHandling} component={errorHandlingContainer} />
